...
export function AgentControlBar({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-card border-border flex flex-col rounded-[31px] border p-3 drop-shadow-md/3',
        className
      )}
      {...props}
    >
        ...
        <div className="flex flex-1 gap-0.5">
          {visibleControls.microphone && (
            <div className="flex items-center gap-0">
              ...
              <hr className="bg-border peer-data-[state=off]/track:bg-destructive relative z-10 -mr-px hidden h-4 w-px md:block" />
              <DeviceSelect
                size="sm"
                kind="audioinput"
